# aterioiden hinnat ovat senteiss�
EDULLINEN = 250
MAUKAS = 400

# HUOM: Kaikki raha-arvot, kuten maksukortin saldo ja aterioiden hinnat ovat senteiss�. 
# Harjoitusty�ss� muuttujat, luokat ja metodit kirjoitetaan englanniksi vaikka kurssimateriaalissa onkin luettavuuden vuoksi k�ytetty suomenkielisi� nimi�.)
class Maksukortti:
